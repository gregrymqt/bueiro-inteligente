...
@router.post("/medicoes", status_code=status.HTTP_200_OK, dependencies=[Depends(RoleChecker(['Admin', 'Manager']))])
...
@router.get("/{bueiro_id}/status", dependencies=[Depends(RoleChecker(['User', 'Admin', 'Manager']))])
