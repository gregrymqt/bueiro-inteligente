...
namespace BueiroInteligente.Features.Auth.Infrastructure.Authentication;
...
public sealed class BueiroInteligenteAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    ...
    protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        try
        {
            UserTokenData currentUser = await _authExtension.GetCurrentUserAsync(
                token,
