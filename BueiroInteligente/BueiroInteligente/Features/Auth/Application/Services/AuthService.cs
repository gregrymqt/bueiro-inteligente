...
using SharedTokenPayload = BueiroInteligente.Extensions.TokenPayload;
...
) : IAuthService
{
    ...
    private readonly AuthExtension _authExtension = authExtension ?? throw new ArgumentNullException(nameof(authExtension));
