...
public sealed record StatCardCreateDto(
    ...
    [property: Required, StringLength(255), Display(Name = "Nome do ícone", Description = "Nome do ícone do Lucide")] string IconName,
...
public sealed record StatCardUpdateDto(
    ...
    [property: StringLength(255), Display(Name = "Nome do ícone", Description = "Nome do ícone do Lucide")] string? IconName = null,
