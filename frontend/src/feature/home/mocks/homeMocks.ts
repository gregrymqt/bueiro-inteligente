...
const initialCarousels: CarouselContent[] = [
  {
    ...
    desktop_image_url: createHeroArtwork('Monitoramento em tempo real', 'Painéis vivos para operação urbana contínua e visual de alta leitura.', '#0f172a', '#1d4ed8', '#22d3ee'),
    mobile_image_url: createHeroArtwork('Monitoramento em tempo real', 'Painéis vivos para operação urbana contínua e visual de alta leitura.', '#0f172a', '#1d4ed8', '#22d3ee'),
  ...
  },
  {
    ...
    desktop_image_url: createHeroArtwork('Alertas antes da rua alagar', 'Visual limpo para destacar risco, prioridade e resposta rápida.', '#111827', '#0f766e', '#34d399'),
    mobile_image_url: createHeroArtwork('Alertas antes da rua alagar', 'Visual limpo para destacar risco, prioridade e resposta rápida.', '#111827', '#0f766e', '#34d399'),
    action_url: '/dashboard',
    order: 2,
    section: 'hero',
  },
  {
    ...
    desktop_image_url: createHeroArtwork('Gestão integrada da equipe', 'Administração, monitoramento e relatórios organizados no mesmo fluxo.', '#1f2937', '#7c2d12', '#fb923c'),
    mobile_image_url: createHeroArtwork('Gestão integrada da equipe', 'Administração, monitoramento e relatórios organizados no mesmo fluxo.', '#1f2937', '#7c2d12', '#fb923c'),
  ...
  },
  {
    ...
    desktop_image_url: createHeroArtwork('Chuva forte prevista para 17h', 'A vigilância do ponto crítico foi reforçada pela operação.', '#111827', '#a16207', '#fde68a'),
    mobile_image_url: createHeroArtwork('Chuva forte prevista para 17h', 'A vigilância do ponto crítico foi reforçada pela operação.', '#111827', '#a16207', '#fde68a'),
    action_url: '/dashboard',
    order: 1,
    section: 'alerts',
  },
  {
    ...
    desktop_image_url: createHeroArtwork('Bueiro 03 em manutenção preventiva', 'Equipe acionada e rota alternativa disponível no painel administrativo.', '#0f172a', '#b91c1c', '#f87171'),
    mobile_image_url: createHeroArtwork('Bueiro 03 em manutenção preventiva', 'Equipe acionada e rota alternativa disponível no painel administrativo.', '#0f172a', '#b91c1c', '#f87171'),
  ...
  },
  {
    ...
    subtitle: '28',
    desktop_image_url: createHeroArtwork('28', 'Bueiros ativos nesta simulação', '#0f172a', '#14532d', '#4ade80'),
    mobile_image_url: createHeroArtwork('28', 'Bueiros ativos nesta simulação', '#0f172a', '#14532d', '#4ade80'),
    action_url: '/dashboard',
    order: 1,
    section: 'stats',
  },
  {
    ...
    subtitle: '3',
    desktop_image_url: createHeroArtwork('3', 'Alertas críticos nesta janela', '#1f2937', '#b45309', '#fbbf24'),
    mobile_image_url: createHeroArtwork('3', 'Alertas críticos nesta janela', '#1f2937', '#b45309', '#fbbf24'),
    action_url: '/dashboard',
    order: 2,
    section: 'stats',
  },
  {
    ...
    subtitle: '2 min',
    desktop_image_url: createHeroArtwork('2 min', 'Última sincronização do painel', '#111827', '#1d4ed8', '#60a5fa'),
    mobile_image_url: createHeroArtwork('2 min', 'Última sincronização do painel', '#111827', '#1d4ed8', '#60a5fa'),
    action_url: '/dashboard',
    order: 3,
    section: 'stats',
  },
...
export const createMockCarouselItem = async (payload: CarouselCreatePayload): Promise<CarouselContent> =>
  withMockLatency(() => {
    const createdItem: CarouselContent = {
      id: createCarouselId(),
      desktop_image_url: 'https://via.placeholder.com/800x400?text=Mock+Image+Desktop', // Fallback for desktop_image_url
      mobile_image_url: 'https://via.placeholder.com/400x400?text=Mock+Image+Mobile', // Fallback for mobile_image_url
      ...payload,
    };
